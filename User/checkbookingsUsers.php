...
<!--<img src="sbcalogo.png" alt="SBCA Logo" width="../cssforlogin/images/sbcalogo.png" "7%" align="center" > -->
    <div class="divlogo"><img src="../cssforlogin/images/sbcalogo.png" alt="SBCA Logo"
...
<div class="divcalendar" style="margin-top:15%">
		...
		$calendar.= '<td class="calendar-day">';
    		...
    		if (mysqli_num_rows($result) > 0) {
    			...
    			while($row = mysqli_fetch_assoc($result)) {
    				...
    				$calendar .= "<b>" ."Event Name: " . $row["eventname"] . "<br>". "Room: ". $row["item"] ."<br>". "Reservee name: ". $row["reservee_name"] ."<br>" ;
