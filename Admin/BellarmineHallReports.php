  ...
  regional: "fi",
    ...
    <?php
	  $db = mysqli_connect('localhost', 'root', '', 'cbfosystem');
					...
					$query = mysqli_query($db,"select *, count(room) as Number from bookingcalendar WHERE room = 'Bellarmine Hall' GROUP by reservee_type ");
...
<script type="text/javascript">  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Reservee of Bellarmine Hall',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
...
<tr>
    <td valign="top">
           ...
           <div style="width:950px;height:50px">  
                <h2>Percentage of Reservee of Bellarmine Hall</h2>  
                <br />  
