  ...
  regional: "fi",
    ...
    <?php
	  $db = mysqli_connect('localhost', 'root', '', 'cbfosystem');
					...
					$query = mysqli_query($db,"select *, count(item) as Number from bookingcalendar WHERE item = 'Rosendo' GROUP by reservee_type ");
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Reservee of Rosendo',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
...
<tr>
    <td valign="top">
           ...
           <div style="width:950px;height:50px">  
                <h2>Percentage of Reservee of Rosendo</h2>  
                <br />  
