...
<?php
	  $db = mysqli_connect('localhost', 'root', '', 'cbfosystem');
					...
					$query = mysqli_query($db,"select *, count(item) as Number from bookingcalendar WHERE item = 'MPH' GROUP by reservee_type ");
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Reservee of MPH',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
...
<tr>
    <td valign="top">
           ...
           <div style="width:950px;height:50px">  
                <h2>Percentage of Reservee of MPH</h2>  
                <br />  
