  ...
  regional: "fi",
    ...
    <?php
	  $db = mysqli_connect('localhost', 'root', '', 'cbfosystem');
					...
					$query = mysqli_query($db,"select *, count(room) as Number from bookingcalendar WHERE room = 'ST.Maur' GROUP by reservee_type ");
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Reservee of ST.Maur',  
                      //is3D:true,  
                      pieHole: 0.4  
                     };  
