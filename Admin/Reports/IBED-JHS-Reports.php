...
<!--<script src="lang/datepicker-fi.js"></script>-->
   ...
   <?php
	  $db = mysqli_connect('localhost', 'root', '', 'cbfosystem');
				  ...
				  $result = $db->query("select *, count(room) as Number from bookingcalendar WHERE Room_Department = 2 GROUP by reservee_type ");
          ...
          <script type="text/javascript">
           ...
           <?php
    $result = $db->query("select *, count(room) as Number from bookingcalendar WHERE School_Level_or_Course = 'Grade 7' OR School_Level_or_Course = 'Grade 8' OR School_Level_or_Course = 'Grade 9' OR School_Level_or_Course = 'Grade 10' GROUP by School_Level_or_Course");     
