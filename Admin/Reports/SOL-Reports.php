...
<!--<script src="lang/datepicker-fi.js"></script>-->
    <?php
	  $db = mysqli_connect('localhost', 'root', '', 'cbfosystem');
				   ...
				   $result = $db->query("select *, count(room) as Number from bookingcalendar WHERE Room_Department = 6 GROUP by reservee_type ");
				?>
         ...
         <?php
   $result = $db->query("select *, count(room) as Number from bookingcalendar WHERE School_Level_or_Course = 'School of Law' GROUP by School_Level_or_Course");
