...
// Captcha
	...
	if(empty($errors))
	{
		...
		$Date = intval(strtotime(htmlspecialchars($_POST["unavailable_day"])));;
        $Reason = htmlspecialchars($_POST["Reason"]);
        $sql = "SELECT * FROM unavailable_dates  WHERE date = $Date";
		$sql1 = "INSERT INTO unavailable_dates (date, reason)
VALUES ('$Date', '$Reason')";
